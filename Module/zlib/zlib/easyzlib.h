...
int ezcompress(unsigned char* pDest, long* pnDestLen, unsigned char* pSrc, long nSrcLen);
int ezuncompress(unsigned char* pDest, long* pnDestLen, unsigned char* pSrc, long nSrcLen);
#ifdef __cplusplus
}
...
private:
	void Init() { pBuf = 0; nSize=0; nLen=0; };
