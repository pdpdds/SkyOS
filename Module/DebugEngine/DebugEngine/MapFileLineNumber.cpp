...
MapFileLineNumber::MapFileLineNumber(std::string		p_lineNumber,
									 MapFileAddress	*mfa)
{
	address = mfa;
	lineNumber = strtoul(p_lineNumber, NULL, 16);
}
...
MapFileLineNumber::MapFileLineNumber(int			p_lineNumber,
									 MapFileAddress	*mfa)
{
	address = mfa;
...
MapFileLineNumber::MapFileLineNumber()
{
	address = NULL;
	lineNumber = 0;
}
