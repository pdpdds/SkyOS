#ifndef _MAP_FILE_ADDRESS_H
#define _MAP_FILE_ADDRESS_H
#include "windef.h"
...
public:
	...
	MAPFILEDLL_API void setAddress(WORD	section,
									DWORD	addr)
	{
	...
	MAPFILEDLL_API void getAddress(WORD		&section,
								   DWORD	&addr)
	{
	...
	MAPFILEDLL_API void getAddressString(std::string	&s);
